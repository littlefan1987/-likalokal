...
User.create(
    ...
    password: p,
    photo: "https://source.unsplash.com/QCPXRvl9Ylc/",
...
User.create(
    ...
    password: p,
    photo: "https://source.unsplash.com/vMV6r4VRhJ8/",
...
User.create(
    ...
    password: p,
    photo: "https://source.unsplash.com/SZ9y9PGVQbY/",
    description: "Always"
  )
...
User.create(
    ...
    password: p,
    photo: "https://source.unsplash.com/aWQhVALvDZ4/",
...
User.create(
    ...
    password: p,
    photo: "https://source.unsplash.com/i4OHxtxiMtk",
...
User.create(
    ...
    password: p,
    photo: "https://source.unsplash.com/iJVDkgWqp3U",
